...
export default function Tela1({status, setStatus}) {
    //logic


    return (
        <div className={`fundo centralizado ${status}`}  >
            ...
            <button  onClick={() => {setStatus("oculto")}} className="botao">Iniciar Recall!</button>
        </div>
    )
}